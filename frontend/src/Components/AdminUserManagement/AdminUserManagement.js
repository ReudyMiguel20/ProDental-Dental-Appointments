...
const AdminUserManagement = () => {
    ...
    return (
        <div className="admin-user-management-container">
                    ...
                    <Table responsive>
                        ...
                        {data.map((user) => (
                            <tr key={user.username}>
                                ...
                                <td>
                                    <select defaultValue={user.enabled ? "enable" : "disable"} onChange={(event) => handleSelectChange(event, user)}>
                                        <option value="enable">Enable</option>
                                        <option value="disable">Disable</option>
                                    </select>
                                </td>
                                <td>
                                    <button style={{backgroundColor: "darkblue"}} onClick={() => toggleModal(user)}>
            ...
            {showModal &&<ModalUserInfo user={selectedUser} closeModal={toggleModal} />}
        < /div>
    )
}
