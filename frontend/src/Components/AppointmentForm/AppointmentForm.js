...
const AppointmentForm = ({ onSuccess }) => {
  ...
  const reverseAppointmentProcedures = Object.entries(
        ...
        <form>
          ...
          <div className="input-container">
            ...
            <input
              type="text"
              disabled={true}
              placeholder="Universidad UFHEC"
              id="location"
            />
            <Popup
              trigger={
                <p style={{ marginLeft: "50px", cursor: "pointer" }}>
                  Como Llegar?
                </p>
              }
          ...
          <button onClick={handleSubmit} className="button-form">
            Agendar Cita
          </button>
        </form>
      </div>
